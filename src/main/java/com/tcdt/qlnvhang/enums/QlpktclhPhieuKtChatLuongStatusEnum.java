...
public enum QlpktclhPhieuKtChatLuongStatusEnum {
    ...
    QlpktclhPhieuKtChatLuongStatusEnum(String id, String ten, String trangThaiDuyet) {
        this.id = id;
        this.ten = ten;
    ...
    public static String getTenById(String id) {
        for (QlpktclhPhieuKtChatLuongStatusEnum status : QlpktclhPhieuKtChatLuongStatusEnum.values()) {
