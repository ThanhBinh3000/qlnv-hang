...
public enum HhBbNghiemthuKlstStatusEnum {
    ...
    HhBbNghiemthuKlstStatusEnum(String id, String ten, String trangThaiDuyet) {
        this.id = id;
        this.ten = ten;
    ...
    public static String getTenById(String id) {
        for (HhBbNghiemthuKlstStatusEnum status : HhBbNghiemthuKlstStatusEnum.values()) {
