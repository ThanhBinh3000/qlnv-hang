...
public class QlnvBkeNhapvtuSpecification {
	public static Specification<QlnvBkeNhapvtuHdr> buildSearchQuery(final QlnvBkeNhapvtuSearchReq objReq) {
		return new Specification<QlnvBkeNhapvtuHdr>() {
			/**
			 * 
			 */
			...
			@Override
			public Predicate toPredicate(Root<QlnvBkeNhapvtuHdr> root, CriteriaQuery<?> query,
