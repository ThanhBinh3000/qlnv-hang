...
public class QlnvBbanTinhkhoSpecification {

	public static Specification<QlnvBbanTinhkho> buildSearchQuery(final QlnvBbanTinhkhoSearchReq objReq) {
		return new Specification<QlnvBbanTinhkho>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 6490234479761962290L;

			@Override
			public Predicate toPredicate(Root<QlnvBbanTinhkho> root, CriteriaQuery<?> query,
