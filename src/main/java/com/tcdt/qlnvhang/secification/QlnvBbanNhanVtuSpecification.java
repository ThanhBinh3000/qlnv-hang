...
public class QlnvBbanNhanVtuSpecification {
	public static Specification<QlnvBbanNhanVtuHdr> buildSearchQuery(final QlnvBbanNhanVtuSearchReq objReq) {
		return new Specification<QlnvBbanNhanVtuHdr>() {
			/**
			 * 
			 */
			...
			@Override
			public Predicate toPredicate(Root<QlnvBbanNhanVtuHdr> root, CriteriaQuery<?> query,
