...
public class XhCtvtTongHopHdrService extends BaseServiceImpl {
    ...
    @Transactional()
    public XhCtvtTongHopHdr save(CustomUserDetails currentUser,XhCtvtTongHopHdrReq obj,SearchXhCtvtDeXuatHdrReq objReq) throws Exception {
        XhCtvtTongHopHdr thopHdr = sumarryData(currentUser,objReq);
        thopHdr.setTrangThai(Contains.DUTHAO);
        thopHdr.setNam(objReq.getNam());
        ...
        thopHdr.setLoaiNhapXuat(objReq.getLoaiNhapXuat());
