...
public class PathContains {
    ...
    public static final String URL_XEM_TRUOC = "/xem-truoc";
    ...
    public static final String BK_BAN_LE = "/bk-ban-le";
    ...
    public static final String QD_PD_BTT = "/qd-pd-btt";
    ...
    public static final String PHIEU_NHAP_KHO = "/phieu-nhap-kho";
    ...
    public static final String NHAP_HANG = "/nhap-hang";
    ...
    public static final String XH_BANG_KE_CAN_HANG = "/xh-bang-ke-can-hang";
    ...
    public static final String MUA_TRUC_TIEP = "/mua-truc-tiep";
    public static final String DX_KH_MTT = "/dx-kh-mtt";
    ...
    public static final String BAO_CAO = "/bao-cao";

    public static final String XUAT_TIEU_HUY = "/xuat-tieu-huy";

    public static final String QUYET_DINH_TIEU_HUY = "/quyet-dinh-tieu-huy";
    ...
    public static final String KET_CHUYEN = "/ket-chuyen";
