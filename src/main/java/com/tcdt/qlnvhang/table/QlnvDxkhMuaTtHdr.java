...
@Data
@NamedEntityGraph(name = "QLNV_DXKH_MUA_TT_HDR.children", attributeNodes = @NamedAttributeNode(value = "children", subgraph = "QLNV_DXKH_MUA_TT_HDR.children.children"), 
subgraphs = @NamedSubgraph(name = "QLNV_DXKH_MUA_TT_HDR.children.children", attributeNodes = @NamedAttributeNode("children")))
