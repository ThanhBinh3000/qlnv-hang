...
@Entity
@Table(name = XhThDanhSachHdr.TABLE_NAME)
@Data
public class XhThDanhSachHdr extends BaseEntity implements Serializable {
  private static final long serialVersionUID = 1L;
  public static final String TABLE_NAME = "XH_TH_DANH_SACH_HDR";

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = XhThDanhSachHdr.TABLE_NAME + "_SEQ")
  @SequenceGenerator(sequenceName = XhThDanhSachHdr.TABLE_NAME + "_SEQ", allocationSize = 1, name = XhThDanhSachHdr.TABLE_NAME + "_SEQ")
  private Long id;
