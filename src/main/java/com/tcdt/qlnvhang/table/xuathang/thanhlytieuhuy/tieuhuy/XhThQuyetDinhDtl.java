...
@Entity
@Table(name = XhThQuyetDinhDtl.TABLE_NAME)
@Data
public class XhThQuyetDinhDtl extends BaseEntity implements Serializable {

  private static final long serialVersionUID = 1L;
  public static final String TABLE_NAME = "XH_TH_QUYET_DINH_DTL";

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = XhThQuyetDinhDtl.TABLE_NAME + "_SEQ")
  @SequenceGenerator(sequenceName = XhThQuyetDinhDtl.TABLE_NAME + "_SEQ", allocationSize = 1, name = XhThQuyetDinhDtl.TABLE_NAME + "_SEQ")
  private Long id;
  private Integer nam;
  ...
  private LocalDate tgianDxTu;
  private LocalDate tgianDxDen;
  ...
  @JsonIgnore
  private XhThQuyetDinhHdr quyetDinhHdr;
}