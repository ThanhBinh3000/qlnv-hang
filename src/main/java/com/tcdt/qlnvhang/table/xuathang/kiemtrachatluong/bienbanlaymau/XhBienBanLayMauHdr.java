...
public class XhBienBanLayMauHdr extends BaseEntity implements Serializable {
  ...
  public void setCanCu(List<FileDKemJoinTable> fileDinhKem) {
    this.canCu.clear();
    if (!DataUtils.isNullObject(fileDinhKem)) {
      fileDinhKem.forEach(s -> {
  ...
  private List<FileDKemJoinTable> anhChupMauNiemPhong = new ArrayList<>();

  public void setAnhChupMauNiemPhong(List<FileDKemJoinTable> fileDinhKem) {
