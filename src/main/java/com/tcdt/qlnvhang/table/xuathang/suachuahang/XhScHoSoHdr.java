...
@Entity
@Table(name = XhScHoSoHdr.TABLE_NAME)
@Getter
@Setter
public class XhScHoSoHdr extends BaseEntity implements Serializable {

  private static final long serialVersionUID = 1L;
  public static final String TABLE_NAME = "XH_SC_HO_SO_HDR";

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = XhScHoSoHdr.TABLE_NAME + "_SEQ")
  @SequenceGenerator(sequenceName = XhScHoSoHdr.TABLE_NAME + "_SEQ", allocationSize = 1, name = XhScHoSoHdr.TABLE_NAME + "_SEQ")
  private Long id;
  private Integer nam;
  ...
  private List<XhScHoSoDtl> hoSoDtl = new ArrayList<>();
}
