...
@Entity
@Table(name = XhTlQuyetDinhPdKqDtl.TABLE_NAME)
@Data
public class XhTlQuyetDinhPdKqDtl extends BaseEntity implements Serializable {
  ...
  @JsonIgnore
  private XhTlQuyetDinhPdKqHdr quyetDinhHdr;
}