...
@Setter
@Entity
@Table(name = XhXkVtBhQdXuatGiamVtDtl.TABLE_NAME)
public class XhXkVtBhQdXuatGiamVtDtl {

  public static final String TABLE_NAME = "XH_XK_VT_BH_QD_XG_VT_DTL";

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = XhXkVtBhQdXuatGiamVtDtl.TABLE_NAME + "_SEQ")
  @SequenceGenerator(sequenceName = XhXkVtBhQdXuatGiamVtDtl.TABLE_NAME + "_SEQ", allocationSize = 1, name = XhXkVtBhQdXuatGiamVtDtl.TABLE_NAME + "_SEQ")
  Long id;
  String maDiaDiem;
  String loaiVthh;
  String donViTinh;
  ...
  @JsonIgnore
  private XhXkVtBhQdXuatGiamVt qdXuatGiamVt;
