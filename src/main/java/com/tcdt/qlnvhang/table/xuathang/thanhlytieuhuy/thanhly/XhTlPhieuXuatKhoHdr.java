...
@Entity
@Table(name = XhTlPhieuXuatKhoHdr.TABLE_NAME)
@Data
@AllArgsConstructor
@NoArgsConstructor
...
//    @SequenceGenerator(sequenceName = XhTlPhieuXuatKhoHdr.TABLE_NAME + "_SEQ", allocationSize = 1, name = XhTlPhieuXuatKhoHdr.TABLE_NAME + "_SEQ")
    ...
    public String getNgayQdXhFormat() {
        return Objects.isNull(this.ngayQdXh) ? null : ngayQdXh.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
    }
