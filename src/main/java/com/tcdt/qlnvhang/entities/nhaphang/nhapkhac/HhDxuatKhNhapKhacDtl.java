...
public class HhDxuatKhNhapKhacDtl {
    public static final String TABLE_NAME = "HH_DX_KHLCNT_DTL";

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "HH_DX_KHLCNT_DTL_SEQ")
    @SequenceGenerator(sequenceName = "HH_DX_KHLCNT_DTL_SEQ", allocationSize = 1, name = "HH_DX_KHLCNT_DTL_SEQ")
    private Long id;
    private Long hdrId;
