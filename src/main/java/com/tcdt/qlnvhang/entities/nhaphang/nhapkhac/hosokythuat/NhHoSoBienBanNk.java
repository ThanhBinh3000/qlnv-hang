...
@Entity
@Table(name = "NH_HO_SO_BIEN_BAN_NK")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NhHoSoBienBanNk extends TrangThaiBaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME = "NH_HO_SO_BIEN_BAN_NK";
    ...
    @Transient
    private List<NhHoSoBienBanCtNk> children = new ArrayList<>();
