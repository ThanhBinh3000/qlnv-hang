...
public class XhKqBttHdr extends BaseEntity implements Serializable {
    ...
    private List<FileDKemJoinTable> fileDaKy = new ArrayList<>();

    public void setFileDaKy(List<FileDKemJoinTable> fileDaKy) {
        this.fileDaKy.clear();
    ...
    private List<FileDKemJoinTable> fileQd = new ArrayList<>();

    public void setFileQd(List<FileDKemJoinTable> fileQd) {
        this.fileQd.clear();
