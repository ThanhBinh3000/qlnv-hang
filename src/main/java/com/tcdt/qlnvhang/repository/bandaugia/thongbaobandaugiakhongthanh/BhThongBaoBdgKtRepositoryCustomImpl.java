...
public class BhThongBaoBdgKtRepositoryCustomImpl implements BhThongBaoBdgKtRepositoryCustom {

    @PersistenceContext
    private EntityManager em;

    @Override
    public List<Object[]> search(BhThongBaoBdgKtSearchReq req, Pageable pageable) {
    ...
    private void setConditionSearchCtkhn(BhThongBaoBdgKtSearchReq req, StringBuilder builder) {
    ...
    @Override
    public int count(BhThongBaoBdgKtSearchReq req) {
        int total = 0;
        StringBuilder builder = new StringBuilder();
    ...
    private void setParameterSearchCtkhn(BhThongBaoBdgKtSearchReq req, Query query) {
