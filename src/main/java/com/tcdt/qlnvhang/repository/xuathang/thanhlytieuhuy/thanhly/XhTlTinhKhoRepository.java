...
@Repository
public interface XhTlTinhKhoRepository extends JpaRepository<XhTlTinhKhoHdr, Long> {
...
//            "AND (:#{#param.ngayXuatKhoDen}  IS NULL OR BK.ngayXuatKho <= :#{#param.ngayXuatKhoDen}))" +
    ...
    Page<XhTlTinhKhoHdr> search(@Param("param") XhTlTinhKhoHdrReq param, Pageable pageable);
