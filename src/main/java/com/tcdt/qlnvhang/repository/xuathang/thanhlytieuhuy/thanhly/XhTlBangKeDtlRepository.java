...
@Repository
public interface XhTlBangKeDtlRepository extends JpaRepository<XhTlBangKeDtl, Long> {
...
//    )
//    Page<XhTlBangKeHdr> search(@Param("param") XhTlBangKeReq param, Pageable pageable);
//
...
//    List<XhTlBangKeHdr> findAllByIdIn(List<Long> listId);
    ...
    List<XhTlBangKeDtl> findByIdHdr(Long idHdr);
