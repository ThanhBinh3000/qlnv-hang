...
//            "qdc.id,qdc.soQdinh,qdc.ngayKyQdinh,khdcd.loaiVthh, khdcd.cloaiVthh,khdcd.tenLoaiVthh, khdcd.tenCloaiVthh, khdcd.maDiemKho,khdcd.tenDiemKho,khdcd.maNhaKho,khdcd.tenNhaKho," +
//            "khdcd.maNganKho,khdcd.tenNganKho, khdcd.maLoKho,khdcd.tenLoKho,khdcd.donViTinh, khdcd.tenDonViTinh ," +
//            "khdcd.tonKho, khdcd.soLuongDc, bbtk.tongSlXuatTheoTt,khdcd.duToanKphi, khdcd.duToanKphi, false, false) " +
...
//    List<DcnbBcKqDcDtl> thongTinNhapXuatHang(@Param("param") DcnbBbKqDcSearch objReq);
}
