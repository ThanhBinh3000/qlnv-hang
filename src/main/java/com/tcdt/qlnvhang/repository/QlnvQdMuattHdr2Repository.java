...
public interface QlnvQdMuattHdr2Repository extends CrudRepository<QlnvQdMuattHdr2, Long> {
	...
	Page<QlnvQdMuattHdr2> selectParams(String soQdinh, String trangThai, Date tuNgayQdinh, Date denNgayQdinh,
