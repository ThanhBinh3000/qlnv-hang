...
import com.tcdt.qlnvhang.service.nhaphang.nhapkhac.impl.HhNkBbNhapDayKhoServiceImpl;
...
@RestController
@RequestMapping(value = PathContains.NHAP_KHAC +PathContains.BIEN_BAN_NHAP_DAY_KHO)
@Slf4j
@Api(tags = "Nhập khác - Biên bản nhập đầy kho")
public class HhNkBbNhapDayKhoController {
    @Autowired
    private HhNkBbNhapDayKhoServiceImpl service;


    @ApiOperation(value = "Tra cứu thông tin", response = List.class)
    @PostMapping(value = PathContains.URL_TRA_CUU, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colection(@RequestBody HhNkBbNhapDayKhoHdrReq objReq) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> getDanhSach(@CurrentUser CustomUserDetails currentUser, @RequestBody HhNkBbNhapDayKhoHdrReq param) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody HhNkBbNhapDayKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody HhNkBbNhapDayKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody HhNkBbNhapDayKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@Valid @RequestBody HhNkBbNhapDayKhoHdrReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody HhNkBbNhapDayKhoHdrReq req) {
        BaseResponse resp = new BaseResponse();
        try {
