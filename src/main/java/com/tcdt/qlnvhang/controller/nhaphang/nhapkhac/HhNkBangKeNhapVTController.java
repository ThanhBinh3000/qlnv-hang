...
@RestController
@RequestMapping(value = PathContains.NHAP_KHAC +PathContains.BANG_KE_NHAP_VAT_TU)
@Slf4j
@Api(tags = "Nhập khác - Bảng kê nhập vật tư")
public class HhNkBangKeNhapVTController {
    @Autowired
    private HhNkBangKeNhapVTService service;


    @ApiOperation(value = "Tra cứu ", response = List.class)
    @PostMapping(value = PathContains.URL_TRA_CUU, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser, @RequestBody HhNkBangKeNhapVTReq objReq) {
    ...
    public ResponseEntity<BaseResponse> insert(@RequestBody HhNkBangKeNhapVTReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody HhNkBangKeNhapVTReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@Valid @RequestBody  HhNkBangKeNhapVTReq objReq, HttpServletResponse response) throws Exception {
        try {
