...
@RestController
@RequestMapping(value = PathContains.NH_HS_BB_NK)
@Slf4j
@Api(tags = "Nhập hàng - Đấu thầu - Kiểm tra chất lượng - Nhập hàng hồ sơ biên bản")
public class NhHoSoBienBanNkController extends BaseController {
    @Autowired
    private NhHoSoBienBanNkService nhHoSoBienBanService;
