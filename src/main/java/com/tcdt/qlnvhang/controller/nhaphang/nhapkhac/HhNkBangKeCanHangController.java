...
import com.tcdt.qlnvhang.service.nhaphang.nhapkhac.impl.HhNkBangKeCanHangServiceImpl;
...
@RestController
@RequestMapping(value = PathContains.NHAP_KHAC +PathContains.BANG_KE_CAN_HANG)
@Slf4j
@Api(tags = "Nhập khác - Bảng kê cân hàng")
public class HhNkBangKeCanHangController {
    @Autowired
    private HhNkBangKeCanHangServiceImpl service;
    ...
    public ResponseEntity<BaseResponse> insert(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody HhNkBangKeCanHangHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody HhNkBangKeCanHangHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> detail(
        ...
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(service.details(ids).get(0));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody HhNkBangKeCanHangHdrReq req) {
        BaseResponse resp = new BaseResponse();
        try {
