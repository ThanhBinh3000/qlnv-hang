...
import com.tcdt.qlnvhang.service.nhaphang.nhapkhac.impl.HhNkBbGiaoNhanServiceImpl;
...
public class HhNkBbGiaoNhanController {
    ...
    public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser, @RequestBody HhNkBbGiaoNhanHdrReq objReq) {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody HhNkBbGiaoNhanHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody HhNkBbGiaoNhanHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody HhNkBbGiaoNhanHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@Valid @RequestBody HhNkBbGiaoNhanHdrReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody HhNkBbGiaoNhanHdrReq req) {
        BaseResponse resp = new BaseResponse();
        try {
