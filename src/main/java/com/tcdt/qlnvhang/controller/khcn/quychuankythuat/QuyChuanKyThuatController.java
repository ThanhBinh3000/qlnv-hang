package com.tcdt.qlnvhang.controller.khcn.quychuankythuat;
...
@Slf4j
@RestController
@RequestMapping(value = "/khcn/quy-chuan-kt")
@Api(tags = "Khoa học công nghệ Quy chuẩn kỹ thuật quốc gia")
public class QuyChuanKyThuatController extends BaseController {
  @Autowired
