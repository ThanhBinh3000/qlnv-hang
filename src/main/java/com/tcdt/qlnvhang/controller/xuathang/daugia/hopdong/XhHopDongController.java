...
public class XhHopDongController {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> preCreate(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody XhHopDongHdrReq req) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhHopDongService.preCreate(currentUser, req));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> preUpdate(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody XhHopDongHdrReq req) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhHopDongService.preUpdate(currentUser, req));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  public ResponseEntity<BaseResponse> updatePreStatus(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody StatusReq stReq) {
    BaseResponse resp = new BaseResponse();
    try {
      xhHopDongService.preApprove(currentUser, stReq);
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
