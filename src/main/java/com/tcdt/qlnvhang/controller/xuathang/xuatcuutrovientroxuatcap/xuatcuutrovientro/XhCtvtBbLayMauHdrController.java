...
@RestController
@RequestMapping(value = PathContains.XUAT_CUU_TRO +PathContains.KIEM_TRA_CHAT_LUONG+PathContains.BIEN_BAN_LAY_MAU)
@Slf4j
@Api(tags = "Xuất hàng DTQG - Xuất cứu trợ viện trợ - Biên bản lấy mẫu/bàn giao mẫu")
public class XhCtvtBbLayMauHdrController extends BaseController {

  @Autowired
  XhCtvtBbLayMauHdrService xhCtvtBbLayMauHdrService;
  ...
  public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser,
                                                @RequestBody SearchXhCtvtBbLayMau objReq) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtBbLayMauHdrService.searchPage(currentUser,objReq));
  ...
  public ResponseEntity<BaseResponse> insert(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody XhCtvtBbLayMauHdrReq objReq) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtBbLayMauHdrService.save(currentUser,objReq));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  public ResponseEntity<BaseResponse> update(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody XhCtvtBbLayMauHdrReq objReq) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtBbLayMauHdrService.update(currentUser,objReq));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  public ResponseEntity<BaseResponse> detail(
    ...
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtBbLayMauHdrService.detail(ids).get(0));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  public ResponseEntity<BaseResponse> updateStatus( @CurrentUser CustomUserDetails currentUser,@Valid @RequestBody StatusReq stReq) {
    BaseResponse resp = new BaseResponse();
    try {
      xhCtvtBbLayMauHdrService.approve(currentUser,stReq);
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody IdSearchReq idSearchReq) {
    BaseResponse resp = new BaseResponse();
    try {
      xhCtvtBbLayMauHdrService.delete(idSearchReq);
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
  ...
  @ResponseStatus(HttpStatus.OK)
  public void exportList(@CurrentUser CustomUserDetails currentUser ,@Valid @RequestBody  SearchXhCtvtBbLayMau objReq, HttpServletResponse response) throws Exception {
    try {
      xhCtvtBbLayMauHdrService.export( currentUser,objReq, response);
  ...
  public ResponseEntity<BaseResponse> preview(@RequestBody HashMap<String, Object> body) {
    ...
    try {
      ...
      resp.setData(xhCtvtBbLayMauHdrService.preview(body));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
