...
import com.tcdt.qlnvhang.service.xuathang.daugia.quyetdinhdieuchinhbdg.XhQdDchinhKhBdgService;
...
public class XhQdDchinhKhBdgController extends BaseController {
    ...
    public ResponseEntity<BaseResponse> searchPage(@Valid @RequestBody XhQdDchinhKhBdgReq objReq) {
