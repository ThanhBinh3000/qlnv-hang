...
public class XhCtvtQuyetDinhGnvController extends BaseController {
  ...
  public ResponseEntity<BaseResponse> list(@CurrentUser CustomUserDetails currentUser,
    ...
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtQuyetDinhGnvService.searchList(currentUser, objReq));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (
            Exception e) {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> preview(@RequestBody XhCtvtQuyetDinhGnvHdrReq objReq) {
    BaseResponse resp = new BaseResponse();
    try {
      resp.setData(xhCtvtQuyetDinhGnvService.preview(objReq));
      resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
      resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
    } catch (Exception e) {
      resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
