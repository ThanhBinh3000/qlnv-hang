...
import com.tcdt.qlnvhang.service.xuathang.daugia.xuatkho.bangkecanhang.XhBangKeCanHangService;
...
@Slf4j
@RestController
@RequestMapping(value = PathContains.XUAT_HANG_DTQG + PathContains.DAU_GIA + PathContains.XH_BANG_KE_CAN_HANG)
@Api(tags = "Xuất hàng - Bán đấu giá - Xuất kho - Bảng kê cân hàng")
public class XhBangKeCanHangController {
    ...
    public ResponseEntity<BaseResponse> create(@Valid @RequestBody XhBangKeCanHangReq req) {
    ...
    @ApiOperation(value = "Sửa thông tin ")
    @PostMapping(value = PathContains.URL_CAP_NHAT, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody XhBangKeCanHangReq req) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateTrangThai(@RequestBody XhBangKeCanHangReq req) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> search(@RequestBody XhBangKeCanHangReq req) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportToExcel(HttpServletResponse response, @RequestBody XhBangKeCanHangReq req) {
        try {
