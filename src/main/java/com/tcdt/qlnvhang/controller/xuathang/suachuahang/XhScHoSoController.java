...
import com.tcdt.qlnvhang.service.xuathang.suachuahang.XhScHoSoService;
...
@RestController
@RequestMapping(value = PathContains.XUAT_HANG_DTQG + PathContains.SUA_CHUA + PathContains.HO_SO)
@Slf4j
@Api(tags = "Xuất hàng DTQG - Xuất thanh lý - Hồ sơ thẩm định")
public class XhScHoSoController {
  @Autowired
