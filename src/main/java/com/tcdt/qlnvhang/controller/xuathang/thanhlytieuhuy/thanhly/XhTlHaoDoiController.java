...
public class XhTlHaoDoiController {
    ...
    @Autowired
    private XhTlHaoDoiService service;
    ...
    public ResponseEntity<BaseResponse> colection(@RequestBody XhTlTinhKhoReq objReq) {
        ...
        try {
            // Search chung api với Biên bản tịnh kho
//            resp.setData(service.searchXhTlTinhKho(objReq));
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody XhTlHaoDoiHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody XhTlHaoDoiHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody XhTlHaoDoiHdrReq stReq) {
        BaseResponse resp = new BaseResponse();
        try {
...
//    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody XhTlHaoDoiHdrReq req) {
        BaseResponse resp = new BaseResponse();
        try {
