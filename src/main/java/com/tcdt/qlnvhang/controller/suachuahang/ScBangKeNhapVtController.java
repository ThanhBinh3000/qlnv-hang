...
import com.tcdt.qlnvhang.service.suachuahang.impl.ScBangKeNhapVtServiceImpl;
...
@RestController
@RequestMapping(value = PathContains.SUA_CHUA + PathContains.BANG_KE_NHAP_VAT_TU)
@Slf4j
@Api(tags = "Sửa chữa hàng DTQG - Bảng kê nhập vật tư")
public class ScBangKeNhapVtController {
    ...
    public ResponseEntity<BaseResponse> insert(@RequestBody ScBangKeNhapVtReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody ScBangKeNhapVtReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody ScBangKeNhapVtReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody ScBangKeNhapVtReq req) {
        BaseResponse resp = new BaseResponse();
        try {
