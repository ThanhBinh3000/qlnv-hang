...
@RestController
@RequestMapping(value = PathContains.SUA_CHUA + PathContains.BAO_CAO)
@Slf4j
@Api(tags = "Sửa chữa hàng DTQG - Báo cáo")
public class ScBaoCaoController {
  @Autowired
  ScBaoCaoService service;

  @ApiOperation(value = "Tra cứu", response = List.class)
  @PostMapping(value = PathContains.URL_TRA_CUU, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colection(@RequestBody ScBaoCaoReq objReq) {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody ScBaoCaoReq objReq) {
    BaseResponse resp = new BaseResponse();
    try {
  ...
  public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody ScBaoCaoReq stReq) {
    BaseResponse resp = new BaseResponse();
    try {
