...
@RestController
@RequestMapping(value = PathContains.SUA_CHUA + PathContains.PHIEU_NHAP_KHO)
@Slf4j
@Api(tags = "Sửa chữa hàng DTQG - Phiếu nhập kho")
public class ScPhieuNhapKhoController {
    @Autowired
    ScPhieuNhapKhoServiceImpl service;
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody ScPhieuNhapKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody ScPhieuNhapKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
