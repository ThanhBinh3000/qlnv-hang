...
@RestController
@RequestMapping(value = PathContains.SUA_CHUA + PathContains.PHIEU_XUAT_KHO)
@Slf4j
@Api(tags = "Sửa chữa hàng DTQG - Phiếu xuất kho")
public class ScPhieuXuatKhoController {
    @Autowired
    ScPhieuXuatKhoServiceImpl service;

    @ApiOperation(value = "Tra cứu thông tin biên bản", response = List.class)
    @PostMapping(value = PathContains.URL_TRA_CUU, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colection(@RequestBody ScPhieuXuatKhoReq objReq) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> getDanhSachTaoBangKe(@RequestBody ScPhieuXuatKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ApiOperation(value = "Tra cứu thông tin biên bản", response = List.class)
    @PostMapping(value = "/ds-kiem-tra-cl", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> getDanhSachKiemTraCl(@RequestBody ScPhieuXuatKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(service.searchDanhSachTaoKiemTraCl(objReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch ( Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody ScPhieuXuatKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody ScPhieuXuatKhoReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody ScPhieuXuatKhoReq stReq) {
        BaseResponse resp = new BaseResponse();
        try {
