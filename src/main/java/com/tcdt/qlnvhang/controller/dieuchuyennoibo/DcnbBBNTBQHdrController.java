...
public class DcnbBBNTBQHdrController {
    ...
    public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser, @RequestBody DcnbBBNTBQHdrReq objReq) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@RequestBody  DcnbBBNTBQHdrReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbBBNTBQHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
