...
import com.tcdt.qlnvhang.service.dieuchuyennoibo.impl.DcnbPhieuNhapKhoServiceImpl;
...
@RestController
@RequestMapping(value = PathContains.DIEU_CHUYEN_NOI_BO + PathContains.PHIEU_NHAP_KHO)
@Slf4j
@Api(tags = "Điều chuyển nội bộ - Phiếu nhập kho")
public class DcnbPhieuNhapKhoController {
    @Autowired
    private DcnbPhieuNhapKhoServiceImpl service;
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> listChung(@RequestBody DcnbPhieuNhapKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody DcnbPhieuNhapKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody DcnbPhieuNhapKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    public ResponseEntity<BaseResponse> updateStatus(@Valid @RequestBody DcnbPhieuNhapKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@Valid @RequestBody DcnbPhieuNhapKhoHdrReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbPhieuNhapKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
