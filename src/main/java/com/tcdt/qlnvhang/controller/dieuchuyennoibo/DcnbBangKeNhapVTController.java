...
public class DcnbBangKeNhapVTController {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody DcnbBangKeNhapVTReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@RequestBody  DcnbBangKeNhapVTReq objReq, HttpServletResponse response) throws Exception {
        try {
