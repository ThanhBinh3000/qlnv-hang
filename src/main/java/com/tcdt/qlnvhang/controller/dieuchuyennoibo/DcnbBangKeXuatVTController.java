...
@RestController
@RequestMapping(value = PathContains.DIEU_CHUYEN_NOI_BO +PathContains.BANG_KE_XUAT_VAT_TU)
@Slf4j
...
public class DcnbBangKeXuatVTController {
    ...
    public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser, @RequestBody DcnbBangKeXuatVTReq objReq) {
    ...
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody DcnbBangKeXuatVTReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@RequestBody  DcnbBangKeXuatVTReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbBangKeXuatVTReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
