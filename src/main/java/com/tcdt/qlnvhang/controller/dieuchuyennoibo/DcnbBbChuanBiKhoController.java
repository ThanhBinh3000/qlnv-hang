...
import com.tcdt.qlnvhang.service.dieuchuyennoibo.impl.DcnbBbChuanBiKhoServiceImpl;
...
public class DcnbBbChuanBiKhoController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> list(@RequestBody DcnbBbChuanBiKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(service.list(objReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch ( Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody DcnbBbChuanBiKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@RequestBody  DcnbBbChuanBiKhoHdrReq objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbBbChuanBiKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
