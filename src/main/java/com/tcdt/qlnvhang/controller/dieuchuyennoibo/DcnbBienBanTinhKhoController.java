...
public class DcnbBienBanTinhKhoController {
    ...
    public ResponseEntity<BaseResponse> list(@CurrentUser CustomUserDetails currentUser,
        ...
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(dcnbBienBanTinhKhoServiceImpl.searchList(currentUser,objReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch ( Exception e) {
            e.printStackTrace();
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbBienBanTinhKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(dcnbBienBanTinhKhoServiceImpl.preview(objReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch (Exception e) {
            resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
