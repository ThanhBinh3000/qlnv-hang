...
@RestController
@RequestMapping(value = PathContains.DIEU_CHUYEN_NOI_BO + PathContains.PHIEU_XUAT_KHO)
@Slf4j
@Api(tags = "Điều chuyển nội bộ - Phiếu xuất kho")
public class DcnbPhieuXuatKhoController {
    ...
    public ResponseEntity<BaseResponse> colection(@CurrentUser CustomUserDetails currentUser,
                                                  @RequestBody SearchPhieuXuatKho objReq) {
    ...
    public ResponseEntity<BaseResponse> listChung(@CurrentUser CustomUserDetails currentUser,
        ...
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(service.searchListChung(currentUser, objReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<BaseResponse> updateStatus(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody StatusReq stReq) {
        BaseResponse resp = new BaseResponse();
        try {
            resp.setData(service.approve(currentUser, stReq));
            resp.setStatusCode(EnumResponse.RESP_SUCC.getValue());
            resp.setMsg(EnumResponse.RESP_SUCC.getDescription());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @ResponseStatus(HttpStatus.OK)
    public void exportList(@CurrentUser CustomUserDetails currentUser,@RequestBody SearchPhieuXuatKho objReq, HttpServletResponse response) throws Exception {
        try {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> preview(@RequestBody DcnbPhieuXuatKhoHdrReq objReq) {
        BaseResponse resp = new BaseResponse();
        try {
